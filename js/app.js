...
$(document).ready(function(){   
    ...
    //春节倒计时
    var starttime = new Date("2020/1/1");
    setInterval(function () {
        ...
        $('.time').html("<p>2020年新年倒计时</p>" + "<p><span>" + day + "</span>" + "天</p>");
        $(".sydate").html(syday);
    ...
    var mess = "<span>激动吗, 小可爱！！</span><span class='B-span2'>傻瓜，新年快乐！</span><span class='B-span2'>2020, happy new year</span>";
    $(".Barrage").append(mess);
    ...
    var this_url=window.location.href;
        ...
        wx.ready(function () {   //需在用户可能点击分享按钮前就先调用
            ...
            wx.updateAppMessageShareData({ 
                title: '2020 happy new year', // 分享标题
